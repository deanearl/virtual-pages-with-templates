	...
	class VirtualPagesTemplates
	{
		...
		{	
			if(isset($_POST['vpt_hidden']) && $_POST['vpt_hidden'] == 'Y') {  
				...
				$_POST['hide_post_id'] = isset($_POST['hide_post_id']) ? $_POST['hide_post_id'] : '0';
                                $_POST['vpt_keyword'] = isset($_POST['vpt_keyword']) ? $_POST['vpt_keyword'] : 'Apple';
		...
		*/
		public function create_virtual($posts)
		{
            ...
            if ((($current_url_trimmed && strpos($virtual_url, $current_url_trimmed) !== FALSE) || $virtual_url == $current_url_trimmed) && ($allow_virtual || (isset($wp_query->query['error']) && $wp_query->query['error'] == '404')) ) 
            {
